...
export const INITIAL_INTERVENTIONS: InterventionLog[] = [
  {
    ...
    status: 'Delivered',
    nudgeMessage: '⚠️ HELIX Cognitive Guardian: Jira ticket ENG-4892 was closed without required SecOps review. Please attach security verification before deployment.',
  ...
  },
  {
    ...
    status: 'Acknowledged',
    nudgeMessage: 'ℹ️ Discount override of 35% for Acme Corp flagged. CFO signoff link attached for rapid 1-click authorization.',
  ...
  },
  {
    ...
    status: 'Escalated',
    nudgeMessage: '🚨 High Liability Exposure: Unlimited indemnity clause detected in MSA draft. Audit Committee notification triggered.',
  ...
  },
  {
    ...
    channel: 'Slack Nudge Bot',
    status: 'Actioned',
    nudgeMessage: '✅ Architectural Nudge: Custom DB hook converted to standard API Gateway rate limiter policy.',
