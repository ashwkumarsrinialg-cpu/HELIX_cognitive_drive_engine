...
class LLMClient:
    ...
    Routes queries across GPT-5.5, Qwen, OpenAI, or local engines with structured output enforcement.
    """
    ...
    def generate(
        ...
        """Generates completion text for a prompt using model router or cognitive fallback."""
    ...
    def _cognitive_fallback_generate(
        ...
        Evaluates input intent and returns structured cognitive diagnostics, recommendations, or RAG answers.
        """
        prompt_lower = prompt.lower()

        # Recommendation Generation Intent
        ...
        # Cognitive Drift Diagnostic Intent
